...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="border border-[var(--editable-border)] bg-white p-5 shadow-sm md:p-6">
      ...
      <button type="submit" disabled={status === 'submitting'} className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 bg-black px-6 text-sm font-black uppercase tracking-[0.16em] text-white transition hover:bg-[var(--slot4-accent-fill)] disabled:cursor-not-allowed disabled:opacity-70">
